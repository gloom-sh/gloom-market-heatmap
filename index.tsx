...
import { formatCompact, formatCurrency, formatPercentRaw } from "gloomberb/utils";
import { isPlainKey } from "gloomberb/utils";
import { usePaneSettingValue } from "gloomberb/react";
import { usePluginTickerActions } from "gloomberb/react";
import { useLiveQuoteEntries } from "gloomberb/quotes";
import {
...
export default marketHeatmapPlugin;
